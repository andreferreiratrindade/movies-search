---
                            title: "Informações Gerais - APIs Admins - v2.0.0-beta.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "156434452_Informa+es+Gerais+-+APIs+Admins+-+v2.0.0-beta.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/156434452/Informa+es+Gerais+-+APIs+Admins+-+v2.0.0-beta.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - APIs Admins - v2.0.0-beta.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
