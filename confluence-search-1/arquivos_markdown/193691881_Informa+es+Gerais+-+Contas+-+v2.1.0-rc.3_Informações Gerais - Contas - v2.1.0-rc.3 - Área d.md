---
                            title: "Informações Gerais - Contas - v2.1.0-rc.3 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "193691881_Informa+es+Gerais+-+Contas+-+v2.1.0-rc.3"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/193691881/Informa+es+Gerais+-+Contas+-+v2.1.0-rc.3"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Contas - v2.1.0-rc.3 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
