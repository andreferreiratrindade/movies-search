---
                            title: "Informações Gerais - Cartão de Crédito - v2.1.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "157417507_Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v2.1.0-rc.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/157417507/Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v2.1.0-rc.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Cartão de Crédito - v2.1.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
