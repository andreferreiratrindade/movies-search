---
                            title: "Informações Gerais - [DA] Direitos Creditórios Descontados​ - v1.0.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "266928170_Informa+es+Gerais+-+DA+Direitos+Credit+rios+Descontados+-+v1.0.0-rc.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/266928170/Informa+es+Gerais+-+DA+Direitos+Credit+rios+Descontados+-+v1.0.0-rc.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DA] Direitos Creditórios Descontados​ - v1.0.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
