---
                            title: "Cenário 22: payroll-credit-portability_api_portability-idempotency_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1276742169_Cen+rio+22+payroll-credit-portability_api_portability-idempotency_test-module_v1+-+CF"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1276742169/Cen+rio+22+payroll-credit-portability_api_portability-idempotency_test-module_v1+-+CF"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Cenário 22: payroll-credit-portability_api_portability-idempotency_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
Objetivo
Garante que o sistema impeça que ocorra uma portabilidade quando houver idempotencia.
Requisito de massa
...
10
Chamada de endpoint POST /portabilities com o mesmo x-idempotency-key e payload da última requisição
Status 202 - Resposta de sucesso
11
Chamada de endpoint POST /portabilities com o mesmo x-idempotency-key mas com payload diferentes da última requisição
Status 422 - Validação de resposta esperando código de erro como "ERRO_IDEMPOTENCIA"
12
Fim do teste
