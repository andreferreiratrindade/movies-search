---
                            title: "Informações Gerais - [DC] Contas - v2.2.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "245760301_Informa+es+Gerais+-+DC+Contas+-+v2.2.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/245760301/Informa+es+Gerais+-+DC+Contas+-+v2.2.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.2.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
