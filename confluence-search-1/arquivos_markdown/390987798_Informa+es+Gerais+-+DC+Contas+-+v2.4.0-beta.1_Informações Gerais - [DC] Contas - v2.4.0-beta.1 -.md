---
                            title: "Informações Gerais - [DC] Contas - v2.4.0-beta.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "390987798_Informa+es+Gerais+-+DC+Contas+-+v2.4.0-beta.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/390987798/Informa+es+Gerais+-+DC+Contas+-+v2.4.0-beta.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.4.0-beta.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
