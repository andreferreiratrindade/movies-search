---
                            title: "Cenário 20: payroll-credit-portability_api_invalid-consent_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1276741936_Cen+rio+20+payroll-credit-portability_api_invalid-consent_test-module_v1+-+CF"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1276741936/Cen+rio+20+payroll-credit-portability_api_invalid-consent_test-module_v1+-+CF"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Cenário 20: payroll-credit-portability_api_invalid-consent_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
Objetivo
Garante que o sistema impeça que ocorra uma portabilidade com um consentimento inválido
Requisito de massa
...
9
Chamada do endpoint POST /portabilities com x-fapi-interaction-id válido, enviando os seguintes valores:
...
Authorization = token vinculado ao consentimento com as permissões do usuário
Status 403 - Validação de mensagem de erro
15
Chamada de endpoint POST /portabilities usando um token vinculado a um consentimento com as permissões de usuário e enviando:
data.institution.creditor.companyCnpj = original companyCnpj
instalmentPeriodicity = original instalmentPeriodicity
proposedContract.totalNumberOfInstalments = original dueInstalments
contractAmount = original contractOutstandingBalance
Authorization = token vinculado a um consentimento com permissões de usuários
Status 403 - Validação de mensagem de erro
16
Chamada de endpoint Get /portabilities/{portabilityId} enviando:
Authorization = token vinculado com consentimento com permissões de usuário.
Status 403 - Validação de mensagem de erro
17
