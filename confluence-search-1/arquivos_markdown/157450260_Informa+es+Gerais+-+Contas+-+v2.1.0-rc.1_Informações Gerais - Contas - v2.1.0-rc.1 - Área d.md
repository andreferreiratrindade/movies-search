---
                            title: "Informações Gerais - Contas - v2.1.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "157450260_Informa+es+Gerais+-+Contas+-+v2.1.0-rc.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/157450260/Informa+es+Gerais+-+Contas+-+v2.1.0-rc.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Contas - v2.1.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
