---
                            title: "Cenário 1: payroll-credit-portability_api_contract-invalid-status_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1276740580_Cen+rio+1+payroll-credit-portability_api_contract-invalid-status_test-module_v1+-+CF"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1276740580/Cen+rio+1+payroll-credit-portability_api_contract-invalid-status_test-module_v1+-+CF"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Cenário 1: payroll-credit-portability_api_contract-invalid-status_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
Objetivo
Garante que o pedido de portabilidade não será criado devido a erros no contrato.
Requisito de massa
Um contrato com a categoria CONSIGNADO_SIAPE e com o campo status como 'EM ANDAMENTO' e o campo isEligible como 'TRUE'
Um contrato com a categoria CONSIGNADO_SIAPE e o campo isEligible como 'FALSE'
Script
...
9
Chamada de enpoint POST /portabilities enviando os seguintes valores:
...
contractAmount = original contractOutstandingBalanc
Status 422 - Esperando código de erro como "EM_ANDAMENTO"
Etapa de criação de solicitação de portabilidade
10
Chamada de endpoint GET /credit-operations/{contractId}/portability-eligibility até encontrar ao menos um contractId com isEligible como "FALSE"
Etapa de busca e validação de contrato
11
Chamada de endpoint GET Loans Contracts/{contractId}
Status 200 - Recuperando instalmentPeriodicity
...
Status 422 - Esperando código de erro como "CONTRATO_NAO_ELEGIVEL"
Etapa de criação de solicitação de portabilidade
15
Fim do teste
