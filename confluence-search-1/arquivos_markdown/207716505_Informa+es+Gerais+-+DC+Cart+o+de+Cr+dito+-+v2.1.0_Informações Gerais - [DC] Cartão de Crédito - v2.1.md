---
                            title: "Informações Gerais - [DC] Cartão de Crédito - v2.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "207716505_Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.1.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/207716505/Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.1.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Cartão de Crédito - v2.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
