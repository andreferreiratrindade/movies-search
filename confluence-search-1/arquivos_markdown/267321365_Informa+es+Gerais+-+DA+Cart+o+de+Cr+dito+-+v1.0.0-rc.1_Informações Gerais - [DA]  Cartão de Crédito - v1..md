---
                            title: "Informações Gerais - [DA]  Cartão de Crédito - v1.0.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "267321365_Informa+es+Gerais+-+DA+Cart+o+de+Cr+dito+-+v1.0.0-rc.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/267321365/Informa+es+Gerais+-+DA+Cart+o+de+Cr+dito+-+v1.0.0-rc.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DA]  Cartão de Crédito - v1.0.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
