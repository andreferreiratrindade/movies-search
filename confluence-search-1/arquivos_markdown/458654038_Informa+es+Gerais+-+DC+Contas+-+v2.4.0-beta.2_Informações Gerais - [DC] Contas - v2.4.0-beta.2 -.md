---
                            title: "Informações Gerais - [DC] Contas - v2.4.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "458654038_Informa+es+Gerais+-+DC+Contas+-+v2.4.0-beta.2"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/458654038/Informa+es+Gerais+-+DC+Contas+-+v2.4.0-beta.2"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.4.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
