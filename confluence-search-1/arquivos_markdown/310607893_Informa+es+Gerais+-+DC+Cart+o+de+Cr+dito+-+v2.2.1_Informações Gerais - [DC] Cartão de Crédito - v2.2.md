---
                            title: "Informações Gerais - [DC] Cartão de Crédito - v2.2.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "310607893_Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.2.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/310607893/Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.2.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Cartão de Crédito - v2.2.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
