---
                            title: "Cenário 5: payroll-credit-portability_api_user-cancelled-portability_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1276740736_Cen+rio+5+payroll-credit-portability_api_user-cancelled-portability_test-module_v1+-+CF"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1276740736/Cen+rio+5+payroll-credit-portability_api_user-cancelled-portability_test-module_v1+-+CF"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Cenário 5: payroll-credit-portability_api_user-cancelled-portability_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
Objetivo
Garante que o cliente crie e cancele um pedido de solicitação portabilidade
Requisito de massa
...
Status 200 - Validação de resposta de acordo com a especificação e data.status igual "RECEIVED"
11
