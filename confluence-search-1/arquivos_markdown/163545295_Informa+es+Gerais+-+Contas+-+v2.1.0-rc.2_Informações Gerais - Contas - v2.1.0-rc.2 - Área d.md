---
                            title: "Informações Gerais - Contas - v2.1.0-rc.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "163545295_Informa+es+Gerais+-+Contas+-+v2.1.0-rc.2"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/163545295/Informa+es+Gerais+-+Contas+-+v2.1.0-rc.2"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Contas - v2.1.0-rc.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
