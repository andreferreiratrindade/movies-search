---
                            title: "Informações Gerais - [DC] Recursos - v3.0.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "345178499_Informa+es+Gerais+-+DC+Recursos+-+v3.0.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/345178499/Informa+es+Gerais+-+DC+Recursos+-+v3.0.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Recursos - v3.0.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
