---
                            title: "Informações Gerais - [DC] Recursos - v3.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1267990545_Informa+es+Gerais+-+DC+Recursos+-+v3.1.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1267990545/Informa+es+Gerais+-+DC+Recursos+-+v3.1.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Recursos - v3.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
