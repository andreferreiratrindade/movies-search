---
                            title: "Informações Gerais - APIs Admins - v2.0.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "185237537_Informa+es+Gerais+-+APIs+Admins+-+v2.0.0-beta.2"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/185237537/Informa+es+Gerais+-+APIs+Admins+-+v2.0.0-beta.2"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - APIs Admins - v2.0.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
