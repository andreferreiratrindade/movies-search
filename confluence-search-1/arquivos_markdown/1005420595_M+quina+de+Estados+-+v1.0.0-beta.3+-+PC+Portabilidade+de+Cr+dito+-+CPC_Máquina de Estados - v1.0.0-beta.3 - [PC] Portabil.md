---
                            title: "Máquina de Estados - v1.0.0-beta.3 - [PC] Portabilidade de Crédito - CPC - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1005420595_M+quina+de+Estados+-+v1.0.0-beta.3+-+PC+Portabilidade+de+Cr+dito+-+CPC"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1005420595/M+quina+de+Estados+-+v1.0.0-beta.3+-+PC+Portabilidade+de+Cr+dito+-+CPC"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Máquina de Estados - v1.0.0-beta.3 - [PC] Portabilidade de Crédito - CPC - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
OBS.: São considerados dias úteis apenas os dias de segunda a sexta-feira, exceto feriados nacionais
