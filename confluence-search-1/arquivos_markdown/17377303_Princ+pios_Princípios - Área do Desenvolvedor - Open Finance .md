---
                            title: "Princípios - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "17377303_Princ+pios"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/17377303/Princ+pios"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Princípios - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
A adoção de mecanismos de segurança no design e implementação das APIs do
Open Finance no Brasil
deverá considerar os padrões aplicáveis a cada uma de suas fases, visando a proteção e a disponibilidade do ecossistema como um todo, considerando clientes, participantes e os dados específicos compartilhados em cada fase.
