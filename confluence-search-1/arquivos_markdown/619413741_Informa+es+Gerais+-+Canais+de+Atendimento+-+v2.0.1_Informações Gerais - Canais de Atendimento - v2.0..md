---
                            title: "Informações Gerais - Canais de Atendimento - v2.0.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "619413741_Informa+es+Gerais+-+Canais+de+Atendimento+-+v2.0.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/619413741/Informa+es+Gerais+-+Canais+de+Atendimento+-+v2.0.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Canais de Atendimento - v2.0.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
