---
                            title: "Informações Gerais - [DC] Contas - v2.5.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1323335697_Informa+es+Gerais+-+DC+Contas+-+v2.5.0-beta.2"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1323335697/Informa+es+Gerais+-+DC+Contas+-+v2.5.0-beta.2"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.5.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
5
Saldos Reservados: GET: accounts/{accountId}/reserved-balances
6
Transações da conta
: (
GET
