---
                            title: "Informações Gerais - [DA]  Cartão de Crédito - v1.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1719173325_Informa+es+Gerais+-+DA+Cart+o+de+Cr+dito+-+v1.1.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1719173325/Informa+es+Gerais+-+DA+Cart+o+de+Cr+dito+-+v1.1.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DA]  Cartão de Crédito - v1.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
