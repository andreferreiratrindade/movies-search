---
                            title: "Informações Gerais - [DC] Cartão de Crédito - v2.3.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "387514804_Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.3.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/387514804/Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.3.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Cartão de Crédito - v2.3.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
