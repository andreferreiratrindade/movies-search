---
                            title: "Informações Gerais - [DA]  Cartão de Crédito - v1.0.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "297500758_Informa+es+Gerais+-+DA+Cart+o+de+Cr+dito+-+v1.0.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/297500758/Informa+es+Gerais+-+DA+Cart+o+de+Cr+dito+-+v1.0.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DA]  Cartão de Crédito - v1.0.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
