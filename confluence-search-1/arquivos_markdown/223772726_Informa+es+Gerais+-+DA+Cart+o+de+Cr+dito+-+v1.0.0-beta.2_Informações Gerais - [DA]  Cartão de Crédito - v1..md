---
                            title: "Informações Gerais - [DA]  Cartão de Crédito - v1.0.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "223772726_Informa+es+Gerais+-+DA+Cart+o+de+Cr+dito+-+v1.0.0-beta.2"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/223772726/Informa+es+Gerais+-+DA+Cart+o+de+Cr+dito+-+v1.0.0-beta.2"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DA]  Cartão de Crédito - v1.0.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
