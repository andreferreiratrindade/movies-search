---
                            title: "Cenário 11: payroll-credit-portability_api_creditor-rejected-payment-nofound_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1276741090_Cen+rio+11+payroll-credit-portability_api_creditor-rejected-payment-nofound_test-module_v1+-+CF"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1276741090/Cen+rio+11+payroll-credit-portability_api_creditor-rejected-payment-nofound_test-module_v1+-+CF"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Cenário 11: payroll-credit-portability_api_creditor-rejected-payment-nofound_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor

                            Tipo do teste
Teste funcional
Descrição
Rejeição de portabilidade pela credora por decurso de prazo do pagamento.
Objetivo
Garante que a credora possa rejeitar um pedido de solicitação portabilidade ao ocorrer decurso de prazo do pagamento.
Requisito de massa
...
10
Serão feitas a chamadas de endpoint GET /portabilities/{portabilityId} a cada 10 minutos enquanto status estiver em "RECEIVED" ou "PENDING" ou “ACCEPTED_SETTLEMENT_IN_PROGRESS”
...
e Etapa de validação da liquidação
11
...
Status 200 - Validação de resposta de acordo com a especificação e data.status igual "REJECTED" e statusReason.reasonType como "DECURSO_DO_PRAZO_PARA_PAGAMENTO"
