---
                            title: "Informações Gerais - [DC] Cartão de Crédito - v2.2.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "245760073_Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.2.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/245760073/Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.2.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Cartão de Crédito - v2.2.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
