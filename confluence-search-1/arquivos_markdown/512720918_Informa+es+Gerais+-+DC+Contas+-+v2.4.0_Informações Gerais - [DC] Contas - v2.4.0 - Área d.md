---
                            title: "Informações Gerais - [DC] Contas - v2.4.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "512720918_Informa+es+Gerais+-+DC+Contas+-+v2.4.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/512720918/Informa+es+Gerais+-+DC+Contas+-+v2.4.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.4.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
