---
                            title: "Informações Gerais - [DC] Contas - v2.4.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "480575529_Informa+es+Gerais+-+DC+Contas+-+v2.4.0-rc.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/480575529/Informa+es+Gerais+-+DC+Contas+-+v2.4.0-rc.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.4.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
