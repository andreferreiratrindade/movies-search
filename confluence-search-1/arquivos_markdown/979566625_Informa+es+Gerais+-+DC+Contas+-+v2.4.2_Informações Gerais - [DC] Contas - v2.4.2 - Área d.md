---
                            title: "Informações Gerais - [DC] Contas - v2.4.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "979566625_Informa+es+Gerais+-+DC+Contas+-+v2.4.2"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/979566625/Informa+es+Gerais+-+DC+Contas+-+v2.4.2"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.4.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
