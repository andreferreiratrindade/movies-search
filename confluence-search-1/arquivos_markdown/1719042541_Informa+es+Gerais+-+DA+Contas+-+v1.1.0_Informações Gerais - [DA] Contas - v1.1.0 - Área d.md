---
                            title: "Informações Gerais - [DA] Contas - v1.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1719042541_Informa+es+Gerais+-+DA+Contas+-+v1.1.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1719042541/Informa+es+Gerais+-+DA+Contas+-+v1.1.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DA] Contas - v1.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
