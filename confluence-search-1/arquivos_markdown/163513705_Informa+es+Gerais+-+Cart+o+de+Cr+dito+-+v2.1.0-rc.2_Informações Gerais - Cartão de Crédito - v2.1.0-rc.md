---
                            title: "Informações Gerais - Cartão de Crédito - v2.1.0-rc.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "163513705_Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v2.1.0-rc.2"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/163513705/Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v2.1.0-rc.2"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Cartão de Crédito - v2.1.0-rc.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
