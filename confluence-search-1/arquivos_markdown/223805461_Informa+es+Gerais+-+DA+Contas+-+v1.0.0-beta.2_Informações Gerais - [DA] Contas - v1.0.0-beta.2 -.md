---
                            title: "Informações Gerais - [DA] Contas - v1.0.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "223805461_Informa+es+Gerais+-+DA+Contas+-+v1.0.0-beta.2"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/223805461/Informa+es+Gerais+-+DA+Contas+-+v1.0.0-beta.2"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DA] Contas - v1.0.0-beta.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
