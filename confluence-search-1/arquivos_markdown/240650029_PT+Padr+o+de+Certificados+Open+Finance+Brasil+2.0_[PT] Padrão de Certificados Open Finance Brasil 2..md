---
                            title: "[PT] Padrão de Certificados Open Finance Brasil 2.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "240650029_PT+Padr+o+de+Certificados+Open+Finance+Brasil+2.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/240650029/PT+Padr+o+de+Certificados+Open+Finance+Brasil+2.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # [PT] Padrão de Certificados Open Finance Brasil 2.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
" (should not) e "
pode
" (may) presentes nesse documento devem ser interpretadas conforme as diretrizes descritas em [ISO Directive Part 2][ISODIR2] observando seguinte equivalência:
...
5.2.2.1. Atributos Open Finance Brasil
serialNumber:
Cadastro Nacional de Pessoal Jurídica (CNPJ) da pessoa jurídica titular do certificado e associado ao atributo UID e Software Statement ID, durante validação junto ao Serviço de Diretório do Open Finance Brasil;
organizationIdentifier:
Código de Participante associado ao CNPJ listado no Serviço de Diretório do Open Finance Brasil; Para certificados emitidos até 31 de Agosto de 2022 o campo utilizado para essa informação era o organizationalUnitName.
UID:
Software Statement ID cadastrado no Serviço de Diretório do Open Finance Brasil e pertencente ao CNPJ e Código de Participante.
...
Tipo de categoria comercial, devendo conter: "Private Organization" ou "Government Entity" ou "Business Entity" ou "Non-Commercial Entity"
...
Código de Participante associado ao CNPJ listado no Serviço de Diretório do Open Finance Brasil. Para certificados emitidos até 31 Agosto de 2022:
...
Soluti
(Cadeia v5 e v10)
Apenas deverá ser aceito certificados indicados com "
Situação: válido
" nestes repositórios do ITI acima referenciados que são de Cadeia ICP-Brasil v5 e v10.
5.2.4. Certificado para Front-End
...
verifique qual é o KID do certificado que deseja o Subject DN, customize a URL e acesse:
https://keystore.directory.openbankingbrasil.org.br/<org-id>/<software-ID>/transport.jwks
