---
                            title: "Informações Gerais - [DC] Contas - v2.3.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "387449476_Informa+es+Gerais+-+DC+Contas+-+v2.3.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/387449476/Informa+es+Gerais+-+DC+Contas+-+v2.3.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.3.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
