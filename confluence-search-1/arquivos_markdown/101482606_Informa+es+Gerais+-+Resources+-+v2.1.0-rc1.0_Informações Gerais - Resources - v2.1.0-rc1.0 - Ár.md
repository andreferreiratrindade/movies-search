---
                            title: "Informações Gerais - Resources - v2.1.0-rc1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "101482606_Informa+es+Gerais+-+Resources+-+v2.1.0-rc1.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/101482606/Informa+es+Gerais+-+Resources+-+v2.1.0-rc1.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Resources - v2.1.0-rc1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
