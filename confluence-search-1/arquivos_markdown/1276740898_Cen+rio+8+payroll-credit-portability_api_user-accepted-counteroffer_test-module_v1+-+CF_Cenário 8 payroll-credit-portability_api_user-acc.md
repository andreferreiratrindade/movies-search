---
                            title: "Cenário 8: payroll-credit-portability_api_user-accepted-counteroffer_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1276740898_Cen+rio+8+payroll-credit-portability_api_user-accepted-counteroffer_test-module_v1+-+CF"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1276740898/Cen+rio+8+payroll-credit-portability_api_user-accepted-counteroffer_test-module_v1+-+CF"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Cenário 8: payroll-credit-portability_api_user-accepted-counteroffer_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor

                            Tipo do teste
Teste funcional
Descrição
Cancelamento de solicitação de portabilidade após aceite de contraproposta
Objetivo
Garante que a credora rejeite pedido de solicitação portabilidade após cliente aceitar a contraproposta
Requisito de massa
...
11
Serão feitas a chamadas de endpoint GET /portabilities/{portabilityId} a cada 10 minutos enquanto status estiver em "PENDING"
Status 200 - Validação de resposta de acordo com a especificação e data.status igual "REJECTED" e data.rejection.rejectedBy como "CREDORA" e statusReason.reasonType como "RETENCAO_DO_CLIENTE"
13
Fim do teste
