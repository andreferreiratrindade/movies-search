---
                            title: "v1.0 - Casos de Erro - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "240650255_v1.0+-+Casos+de+Erro"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/240650255/v1.0+-+Casos+de+Erro"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # v1.0 - Casos de Erro - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor

                            A
convenção do Open Finance Brasil
mapeou alguns erros esperados durante o fluxo do usuário no ecossistema. Existem orientações específicas já tratadas no
Manual do Usuário
. Aqui, trataremos a visão mais técnica do que pode ser feito em caso de erro.
...
Durante o redirecionamento do Consentimento, houve um problema inesperado no servidor do Transmissor (
Timeout
, queda de Internet, etc.): Além da orientação do usuário, deve-se perceber que o fluxo de Consentimento continua pendente. Como a intenção de Consentimento segue válida por 60 minutos, deve-se tentar utilizar o mesmo consentimento para tentar novamente a autorização do usuário.
