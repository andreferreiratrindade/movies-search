---
                            title: "Especificação Técnica - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "37945356_Especifica+o+T+cnica"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/37945356/Especifica+o+T+cnica"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Especificação Técnica - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
client
, ao passo que a parte que devolve os dados é o
server
. Portanto, supondo que A faça uma consulta em B pelos dados de uma conta, esses dados vão ser transmitidos por quem recebeu a solicitação, e recebidos por quem a fez, nesse caso, "A" é o client e "B" é o server. Em contextos onde os termos "transmissor" e "receptor" são utilizados, eles passam a significar "server" e "client" respectivamente.
PCM
Acrônimo para Plataforma de Coleta de Métricas.
Reporte
No contexto da API de Coleta de Métricas, um
reporte
é o registro da chamada que será enviado tanto pelo server quanto pelo client. Esse registro será armazenado na Plataforma para posterior processo de conciliação de chamadas e extração de dados estatísticos.
Software Statement
Um participante do Open Finance é sempre identificador pelo seu
organisationId
(com "s"). Um
organisationId
um ou mais software statements, que identifica uma instancia de software autorizada a consumir os serviços do ecossistema.
