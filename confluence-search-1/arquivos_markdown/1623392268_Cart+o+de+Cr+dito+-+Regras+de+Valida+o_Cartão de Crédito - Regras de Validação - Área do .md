---
                            title: "Cartão de Crédito - Regras de Validação - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1623392268_Cart+o+de+Cr+dito+-+Regras+de+Valida+o"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1623392268/Cart+o+de+Cr+dito+-+Regras+de+Valida+o"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Cartão de Crédito - Regras de Validação - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
Role = CLIENT
E
endpoint = %/credit-cards-accounts/%
E
método = GET
ENTÃO
