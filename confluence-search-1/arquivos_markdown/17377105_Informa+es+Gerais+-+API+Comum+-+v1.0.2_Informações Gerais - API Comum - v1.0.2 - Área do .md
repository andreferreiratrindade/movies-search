---
                            title: "Informações Gerais - API Comum - v1.0.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "17377105_Informa+es+Gerais+-+API+Comum+-+v1.0.2"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/17377105/Informa+es+Gerais+-+API+Comum+-+v1.0.2"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - API Comum - v1.0.2 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
