---
                            title: "Informações Gerais - Contas - v1.0.3 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "17372249_Informa+es+Gerais+-+Contas+-+v1.0.3"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/17372249/Informa+es+Gerais+-+Contas+-+v1.0.3"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Contas - v1.0.3 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
