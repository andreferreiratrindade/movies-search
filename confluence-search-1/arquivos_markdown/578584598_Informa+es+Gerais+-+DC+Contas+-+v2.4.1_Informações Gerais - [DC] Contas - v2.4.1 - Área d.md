---
                            title: "Informações Gerais - [DC] Contas - v2.4.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "578584598_Informa+es+Gerais+-+DC+Contas+-+v2.4.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/578584598/Informa+es+Gerais+-+DC+Contas+-+v2.4.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.4.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
