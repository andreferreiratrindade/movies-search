---
                            title: "Informações Gerais - [DC] Contas - v2.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "207716736_Informa+es+Gerais+-+DC+Contas+-+v2.1.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/207716736/Informa+es+Gerais+-+DC+Contas+-+v2.1.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.1.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
