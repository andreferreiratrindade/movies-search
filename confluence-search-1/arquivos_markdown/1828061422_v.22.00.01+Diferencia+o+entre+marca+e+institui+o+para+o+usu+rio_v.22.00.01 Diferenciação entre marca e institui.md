---
                            title: "v.22.00.01 Diferenciação entre "marca" e "instituição" para o usuário - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1828061422_v.22.00.01+Diferencia+o+entre+marca+e+institui+o+para+o+usu+rio"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1828061422/v.22.00.01+Diferencia+o+entre+marca+e+institui+o+para+o+usu+rio"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # v.22.00.01 Diferenciação entre "marca" e "instituição" para o usuário - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor

                            Complementando as informações apresentadas na
página anterior
, esta página apresenta definições e orientações sobre o uso e a identificação de marcas no contexto do Open Finance Brasil, trazendo exemplos que apoiam o reconhecimento pelo usuário e a aplicação consistente das marcas ao longo das jornadas, complementando as informações apresentadas no capítulo anterior.
Marca e instituição podem parecer semelhantes para os usuários, mas apresentam diferenças conceituais.
Requisitos
Marca
