---
                            title: "Cenário 3: credit-portability_api_contract-term_test-module_v1 - CPC - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1329299567_Cen+rio+3+credit-portability_api_contract-term_test-module_v1+-+CPC"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1329299567/Cen+rio+3+credit-portability_api_contract-term_test-module_v1+-+CPC"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Cenário 3: credit-portability_api_contract-term_test-module_v1 - CPC - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor

                            Tipo do teste
Teste funcional
Descrição
Criação de solicitação de portabilidade e envio para analise de IF Credora com termos menores que o contrato original
Objetivo
Garante que o pedido de portabilidade seja criado com sucesso
Requisito de massa
...
proposedContract.totalNumberOfInstalments < lesser then original dueInstalments
