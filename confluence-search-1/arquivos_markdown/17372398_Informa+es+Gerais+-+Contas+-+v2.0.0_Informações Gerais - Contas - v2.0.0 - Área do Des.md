---
                            title: "Informações Gerais - Contas - v2.0.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "17372398_Informa+es+Gerais+-+Contas+-+v2.0.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/17372398/Informa+es+Gerais+-+Contas+-+v2.0.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Contas - v2.0.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
