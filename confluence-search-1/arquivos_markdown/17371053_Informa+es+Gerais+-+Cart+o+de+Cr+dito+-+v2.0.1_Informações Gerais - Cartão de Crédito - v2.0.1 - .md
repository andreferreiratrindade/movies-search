---
                            title: "Informações Gerais - Cartão de Crédito - v2.0.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "17371053_Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v2.0.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/17371053/Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v2.0.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Cartão de Crédito - v2.0.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
