---
                            title: "Calendário de eventos - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "147357697_Calend+rio+de+eventos"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/147357697/Calend+rio+de+eventos"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Calendário de eventos - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor

                            Na página de
Calendários
são publicados os eventos públicos do ecossistema onde é possível verificar o cronograma de publicação das APIs regulatórias, de desenvolvimento, testes e Go Live. O calendário possui os cronogramas grupos de APIs e também s eventos que transcendem a todos os grupos.
Orientações de uso:
