---
                            title: "Cenário 7: payroll-credit-portability_api_user-cancelled-counteroffer-progress_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1276740839_Cen+rio+7+payroll-credit-portability_api_user-cancelled-counteroffer-progress_test-module_v1+-+CF"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1276740839/Cen+rio+7+payroll-credit-portability_api_user-cancelled-counteroffer-progress_test-module_v1+-+CF"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Cenário 7: payroll-credit-portability_api_user-cancelled-counteroffer-progress_test-module_v1 - CF - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor

                            Tipo do teste
Teste funcional
Descrição
Criação e cancelamento de solicitação de portabilidade
Objetivo
Garante que o cliente cancele um pedido de solicitação portabilidade após rejeitar a contraproposta ou credora não enviar uma contraproposta.
Requisito de massa
...
Etapa de contraproposta e Etapa de liquidação de contrato
11
...
Etapa de cancelamento da solicitação de portabilidade
12
Chamada de endpoint GET /portabilities/{portabilityId}
Status 200 - Campo status igual a "CANCELLED" e statusReason.reasonType como "CANCELADO_PELO_CLIENTE"
13
Fim do teste
