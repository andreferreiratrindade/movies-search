---
                            title: "Máquina de Estados - v1.0.0 - [PC] Portabilidade de Crédito - CPC. - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1757741057_M+quina+de+Estados+-+v1.0.0+-+PC+Portabilidade+de+Cr+dito+-+CPC."
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1757741057/M+quina+de+Estados+-+v1.0.0+-+PC+Portabilidade+de+Cr+dito+-+CPC."
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Máquina de Estados - v1.0.0 - [PC] Portabilidade de Crédito - CPC. - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
O cliente poderá solicitar o cancelamento do pedido de portabilidade por meio do canal digital da instituição credora, enquanto a solicitação estiver no estado PENDING. Caso essa solicitação seja realizada nessa condição, o pedido de portabilidade deverá ser alterado para o estado
CANCELLED
.
...
no mesmo dia
em que o pedido entrar neste estado.
...
.
Caso a instituição proponente não realize a liquidação do contrato, a instituição credora deve atualizar a máquina de estados, para
REJECTED
, informando o motivo
