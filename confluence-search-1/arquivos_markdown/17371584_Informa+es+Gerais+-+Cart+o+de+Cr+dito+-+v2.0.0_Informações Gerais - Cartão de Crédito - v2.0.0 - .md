---
                            title: "Informações Gerais - Cartão de Crédito - v2.0.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "17371584_Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v2.0.0"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/17371584/Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v2.0.0"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Cartão de Crédito - v2.0.0 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
