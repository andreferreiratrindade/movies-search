---
                            title: "Informações Gerais - Cartão de Crédito - v1.0.4 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "17371421_Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v1.0.4"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/17371421/Informa+es+Gerais+-+Cart+o+de+Cr+dito+-+v1.0.4"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Cartão de Crédito - v1.0.4 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
