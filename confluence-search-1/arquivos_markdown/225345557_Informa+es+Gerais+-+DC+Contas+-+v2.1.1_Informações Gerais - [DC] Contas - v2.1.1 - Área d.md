---
                            title: "Informações Gerais - [DC] Contas - v2.1.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "225345557_Informa+es+Gerais+-+DC+Contas+-+v2.1.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/225345557/Informa+es+Gerais+-+DC+Contas+-+v2.1.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.1.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
