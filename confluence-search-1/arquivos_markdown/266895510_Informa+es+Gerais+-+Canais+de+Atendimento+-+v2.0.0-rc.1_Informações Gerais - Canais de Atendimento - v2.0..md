---
                            title: "Informações Gerais - Canais de Atendimento - v2.0.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "266895510_Informa+es+Gerais+-+Canais+de+Atendimento+-+v2.0.0-rc.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/266895510/Informa+es+Gerais+-+Canais+de+Atendimento+-+v2.0.0-rc.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Canais de Atendimento - v2.0.0-rc.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
