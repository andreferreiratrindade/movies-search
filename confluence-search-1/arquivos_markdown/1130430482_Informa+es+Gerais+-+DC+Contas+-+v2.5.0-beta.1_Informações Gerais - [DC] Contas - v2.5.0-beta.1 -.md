---
                            title: "Informações Gerais - [DC] Contas - v2.5.0-beta.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1130430482_Informa+es+Gerais+-+DC+Contas+-+v2.5.0-beta.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1130430482/Informa+es+Gerais+-+DC+Contas+-+v2.5.0-beta.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Contas - v2.5.0-beta.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
