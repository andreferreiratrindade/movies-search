---
                            title: "Informações Gerais - Webhook - v1.0.0-beta.3 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "125370389_Informa+es+Gerais+-+Webhook+-+v1.0.0-beta.3"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/125370389/Informa+es+Gerais+-+Webhook+-+v1.0.0-beta.3"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Webhook - v1.0.0-beta.3 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
:
Open
Diagrama de sequência da consulta de um consentimento por parte da iniciadora
Open
Diagrama de sequência da consulta de um pagamento por parte da iniciadora
Premissas
