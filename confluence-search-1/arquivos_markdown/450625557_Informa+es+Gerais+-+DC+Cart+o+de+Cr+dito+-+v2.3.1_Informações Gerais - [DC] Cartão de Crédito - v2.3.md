---
                            title: "Informações Gerais - [DC] Cartão de Crédito - v2.3.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "450625557_Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.3.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/450625557/Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.3.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Cartão de Crédito - v2.3.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
