---
                            title: "Informações Gerais - Contas - v2.0.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "17371899_Informa+es+Gerais+-+Contas+-+v2.0.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/17371899/Informa+es+Gerais+-+Contas+-+v2.0.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - Contas - v2.0.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
