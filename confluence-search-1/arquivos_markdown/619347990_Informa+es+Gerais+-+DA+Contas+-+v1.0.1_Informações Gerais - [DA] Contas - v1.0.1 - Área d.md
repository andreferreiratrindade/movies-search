---
                            title: "Informações Gerais - [DA] Contas - v1.0.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "619347990_Informa+es+Gerais+-+DA+Contas+-+v1.0.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/619347990/Informa+es+Gerais+-+DA+Contas+-+v1.0.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DA] Contas - v1.0.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
