---
                            title: "Informações Gerais - [DC] Cartão de Crédito - v2.4.0-beta.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "1130333059_Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.4.0-beta.1"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/1130333059/Informa+es+Gerais+-+DC+Cart+o+de+Cr+dito+-+v2.4.0-beta.1"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # Informações Gerais - [DC] Cartão de Crédito - v2.4.0-beta.1 - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
