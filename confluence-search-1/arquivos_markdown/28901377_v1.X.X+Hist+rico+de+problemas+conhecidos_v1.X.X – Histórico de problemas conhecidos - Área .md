---
                            title: "v1.X.X – Histórico de problemas conhecidos - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "28901377_v1.X.X+Hist+rico+de+problemas+conhecidos"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/28901377/v1.X.X+Hist+rico+de+problemas+conhecidos"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # v1.X.X – Histórico de problemas conhecidos - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
Instituição obtém o organizationId através da Cadeia Access-Token > SSA > Organização e em caso de divergência retorna um erro 403
Instituição utiliza o iss presente no JWT para obter os certificados de assinatura do organizationId e compara o resultado da assinatura, caso o iss esteja inválido a assinatura não estará correta e será retornado um erro 400
