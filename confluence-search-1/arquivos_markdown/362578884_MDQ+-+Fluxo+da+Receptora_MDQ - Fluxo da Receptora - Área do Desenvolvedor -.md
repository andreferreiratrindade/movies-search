---
                            title: "MDQ - Fluxo da Receptora - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor"
                            paginaId: "362578884_MDQ+-+Fluxo+da+Receptora"
                            url: "https://openfinancebrasil.atlassian.net/wiki/spaces/OF/pages/362578884/MDQ+-+Fluxo+da+Receptora"
                            source: "Open Finance Brasil Confluence"
                            ---

                            # MDQ - Fluxo da Receptora - Área do Desenvolvedor - Open Finance Brasil - Área do Desenvolvedor
...
4.
SERVICE
O Serviço gera uma nova requisição, tendo como base a Resposta da TRANSMISORA, incluindo no cabeçalho o valor de [EndpointName] e [serverOrgId] que indica o ID do transmissor (enviar somente validações de solicitações bem-sucedidas - 2xx)
5.
SERVICE
O serviço envia a nova solicitação para a API do MQD
6.
MQD
